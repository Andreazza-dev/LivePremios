        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <span>{{(isset($tipo) AND $tipo == 'individual') ? 'Listando usuários para essa regra!' : 'Listando grupos para essa regra!'}}</span>
                ...
                <form action="{{route('permissions.rules.permissions.store', $id)}}" method="POST">
                    @csrf
                    <div class="card-body">
                                    ...
                                    <div class="panel-body">
                                        <select name="inativos[]" id="available-select" class="multiselect available form-control"
                                            ...
                                            @foreach ($inativos as $inativo)
                                                <option value="{{$inativo->id}}">{{$inativo->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{route('permissions.rules.list')}}"
